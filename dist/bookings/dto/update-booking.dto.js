...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Nouveau statut de la réservation', enum: booking_entity_1.BookingStatus }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsEnum)(booking_entity_1.BookingStatus),
    __metadata("design:type", String)
], UpdateBookingDto.prototype, "status", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Raison d\'annulation', required: false }),
    (0, class_validator_1.IsOptional)(),
