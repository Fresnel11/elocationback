...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Créer une nouvelle demande' }),
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer toutes les demandes' }),
    __metadata("design:type", Function),
...
__decorate([
    (0, common_1.Get)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer une demande par ID' }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Modifier une demande' }),
    __param(0, (0, common_1.Param)('id')),
