...
let AdSeeder = class AdSeeder {
    constructor(adRepository, userRepository, categoryRepository) {
    ...
    async seed() {
        ...
        for (let i = 0; i < adsData.length; i++) {
            ...
            const ad = this.adRepository.create(Object.assign(Object.assign({}, adData), { location: randomLocation, userId: randomUser.id, categoryId: selectedCategory.id, whatsappNumber: `+229${Math.floor(Math.random() * 90000000) + 10000000}` }));
            await this.adRepository.save(ad);
        }
        console.log('20 annonces créées avec succès');
    }
};
exports.AdSeeder = AdSeeder;
exports.AdSeeder = AdSeeder = __decorate([
...
//# sourceMappingURL=ad.seeder.js.map