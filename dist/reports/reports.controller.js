...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Créer un signalement' }),
...
__decorate([
    ...
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer tous les signalements (Admin)' }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer mes signalements' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Récupérer un signalement par ID (Admin)' }),
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(user_role_enum_1.UserRole.ADMIN),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiOperation)({ summary: 'Mettre à jour le statut d\'un signalement (Admin)' }),
    __param(0, (0, common_1.Param)('id')),
...
exports.ReportsController = ReportsController = __decorate([
    (0, swagger_1.ApiTags)('Signalements'),
